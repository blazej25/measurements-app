...
import { Button, ScrollView, StyleProp, Text, TouchableOpacity, View, ViewStyle } from 'react-native';
      ...
      <TouchableOpacity
        onPress={() => {
          ...
          if (times.length == 0) {
            ...
            newTimes = times.concat([{ startingHour: newStartTime, endingHour: newEndTime, key: newKey }])
          }
          setTimes(newTimes)
        }}
        style={buttonStyle}>
